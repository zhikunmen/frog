...
declare module gmbox {
     ...
     * 头像信息框
     */
    function openUserInfoDialog(params: {
        uid: string;
    }): void;
    /**
     * 系统信息
     ...
     * 显示Toast
     */
    function showToast(any): any;
    /**
     * 获取网络状态 NetworkType
     */
    function getNetworkType(): string;

    function logEvent(any):void;
    /**
     * 给游戏调用，可以隐藏/显示回退箭头以及麦克风View
     * param：{"action":"1"} //1.隐藏回退键 2. 显示回退键 3. 隐藏麦克风 4. 显示麦克风
     */
    function updateActionView(params: any): any;
    /**
     * 用户信息返回
     *  */
    interface IUserInfo {
    ...
    class Battle {
        ...
        */
         ...
         * 发送表情
        */
        postEmojiMessage({id: number}: {
            id: any;
        }): void;
        /**
         * 收到表情
        */
        onEmojiMessage(callback: Function): void;
    }
}
/**
 * onLoad回调
