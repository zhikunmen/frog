...
var GameLongJumpView = (function (_super) {
    ...
    function GameLongJumpView() {
        ...
        _this.sound = false;
        _this.onGameResult = function (result) {
            if (result == 'win') {
                _this.result.win();
            }
            else {
        ...
        _this.addEmoji = function () {
            App.MessageCenter.addListener('onEmojiMessage', function (res) {
                _this.playEmoji(res.id, false);
            }, _this);
            _this.addChild(_this.emojiLayer);
            _this.emojiLayer.touchThrough = true;
            _this.emojiLayer.width = App.GameWidth;
            _this.emojiLayer.y = App.GameHeight - 150;
            _this.emojiLayer.horizontalCenter = 0;
            var layout = new eui.HorizontalLayout();
            layout.horizontalAlign = 'center';
            layout.gap = 15;
            _this.emojiLayer.layout = layout;
        };
        _this.playEmoji = function (index, isSelf) {
        };
        ...
        _this.emojiLayer = new eui.Group();
        return _this;
    }
    ...
    GameLongJumpView.prototype.pressBegin = function (evt) {
    ...
    GameLongJumpView.prototype.RandomNum = function (min, max) {
    ...
    GameLongJumpView.GAME_WIDTH = 640;
    GameLongJumpView.GAME_HEIGHT = 1136;
...
(function (GameLongJump) {
    var LongJumpReady = (function (_super) {
        ...
        function LongJumpReady(callback) {
            ...
            _this.imgReady.x = _this.imgGo.x = App.GameWidth / 2;
...
(function (GameLongJump) {
    ...
    (function (PlatformType) {
        ...
        PlatformType[PlatformType["max_r"] = 11] = "max_r";
        PlatformType[PlatformType["max_t"] = 12] = "max_t";
        PlatformType[PlatformType["max_u"] = 13] = "max_u";
        PlatformType[PlatformType["max_w"] = 14] = "max_w";
        PlatformType[PlatformType["max_y"] = 15] = "max_y";
        PlatformType[PlatformType["k"] = 16] = "k";
        PlatformType[PlatformType["e"] = 17] = "e";
        PlatformType[PlatformType["l"] = 18] = "l";
        PlatformType[PlatformType["w"] = 19] = "w";
    ...
    var Platform = (function (_super) {
        ...
        Platform.prototype.init = function (type, UID, isPlayCartoon) {
            ...
            if (this.platformType === PlatformType.max_e || this.platformType === PlatformType.max_r ||
...
(function (GameLongJump) {
    var StateController = (function (_super) {
        ...
        StateController.prototype.init = function () {
            ...
            selfHead.addEventListener(egret.TouchEvent.TOUCH_TAP, function () {
            ...
            comHead.addEventListener(egret.TouchEvent.TOUCH_TAP, function () {
...
(function (GameLongJump) {
    var userConfig = (function () {
        ...
        userConfig.score = 99999; //比分最大值(zgs修改)
        return userConfig;
    }());
